...
RaftRetCode HWElemINA219::sendCmdBinary(uint32_t formatCode, const uint8_t* pData, uint32_t dataLen)
{
...
RaftRetCode HWElemINA219::sendCmdJSON(const char* cmdJSON)
{
    return RaftRetCode::RAFT_RET_OK;
}
