...
#ifdef DEBUG_OVERASCII_UNIT_TEST
    Raft::logHexBuf(testFrame1, sizeof(testFrame1), MODULE_PREFIX, "ProtocolOverAscii original");
#endif
...
#ifdef DEBUG_OVERASCII_UNIT_TEST
    Raft::logHexBuf(outFrame, outLen, MODULE_PREFIX, "ProtocolOverAscii encoded");
#endif
...
#ifdef DEBUG_OVERASCII_UNIT_TEST
    Raft::logHexBuf(decodedFrame, decodePos, MODULE_PREFIX, "ProtocolOverAscii decoded");
#endif
