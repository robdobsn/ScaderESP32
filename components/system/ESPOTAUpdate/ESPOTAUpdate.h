...
public:
    ...
    virtual UtilsRetCode::RetCode fileStreamDataBlock(FileStreamBlock& fileStreamBlock) override final;
...
private:
    ...
    UtilsRetCode::RetCode apiESPFirmwarePart(const String& req, FileStreamBlock& fileStreamBlock, const APISourceInfo& sourceInfo);
    void apiESPFirmwareUpdateDone(const String &reqStr, String &respStr, const APISourceInfo& sourceInfo);

    // Direct firmware update
    virtual UtilsRetCode::RetCode fwUpdateAPIPart(FileStreamBlock& fileStreamBlock);
